...
<html>
    ...
    <body>
        <div id="logreg-forms" >
        <form name='register' onSubmit="return formValidation();" class="form-signin" action="register">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Student Sign Up</h1>
            <hr>
            <input type="text" name="name" id="inputEmail" class="form-control" placeholder="Name" required="" autofocus="" name="name" />
            <input type="email" name="email" id="inputEmail" class="form-control" placeholder="Email" required="" autofocus="" name="email" />
            <input type="password" name="password" id="inputPassword" class="form-control" placeholder="Password" required="" name="pass" /><br>
