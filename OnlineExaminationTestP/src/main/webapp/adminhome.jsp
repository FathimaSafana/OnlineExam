              ...
              <div class="container">
                ...
                <p>
                  <select name="examsubject">
                      <option name="jv" value="Java">Java</option>
...
<!--                 <input type="submit" value="Select Exam"><br/><br/> -->
                <a href="viewusers.jsp" id="view_questions">select exam</a><br/>
                 <%
                 ...
                 <p>Once you have selected an exam to edit click on "Question Section" to either add questions to the examination or view the exam</p>
                </div>
                </div>
